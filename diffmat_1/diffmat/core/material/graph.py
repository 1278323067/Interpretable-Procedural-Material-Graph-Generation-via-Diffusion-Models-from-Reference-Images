...
class MaterialGraph(BaseGraph[BaseMaterialNode]):
    ...
    def evaluate(self, benchmarking: bool = False) -> th.Tensor:
        ...
        return    self.evaluate_maps(benchmarking=benchmarking)[0] #self.renderer(*self.evaluate_maps(benchmarking=benchmarking)) ##
    ...
    def modify_get_parameters_as_config(self, filter_exposed: int = FILTER_OFF,
