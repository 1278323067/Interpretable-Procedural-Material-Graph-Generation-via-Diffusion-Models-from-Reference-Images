...
def c2g(img_in: th.Tensor, flatten_alpha: bool = False,
        rgba_weights: FloatVector = [0.299, 0.587, 0.114, 0.0], bg: FloatValue = 1.0) -> th.Tensor:
...
@input_check(1)
def transform_2d(img_in: th.Tensor, tiling: int = 0, sample_mode: str = 'bilinear',
...
@input_check(2, channel_specs='.g')
def slope_blur(img_in: th.Tensor, img_mask: th.Tensor, samples: int = 32, mode: str = 'blur',
               intensity: FloatValue = 10.0) -> th.Tensor:
