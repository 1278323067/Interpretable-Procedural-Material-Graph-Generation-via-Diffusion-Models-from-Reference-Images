...
def main():
    ...
    ## I/O path
    parser.add_argument('-input', metavar='FILE',default=r"C:\Users\lvxiaoyu\Desktop\Substance_graph.sbs", help='Path to the input *.sbs file')
    ...
    parser.add_argument('-im', '--input-image', metavar='FILE', default=r"C:\Users\lvxiaoyu\Desktop\test.png",
